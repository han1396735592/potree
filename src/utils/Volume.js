...
export class CylinderVolume extends Volume {

    constructor(args = {}) {
        super(args);

        this.constructor.counter = (this.constructor.counter === undefined) ? 0 : this.constructor.counter + 1;
        this.name = 'cylinder_' + this.constructor.counter;


        let cylinderGeometry = new THREE.CylinderGeometry(1, 1, 1, 32);
    ...
    // see https://en.wikipedia.org/wiki/Ellipsoid#Volume
    getVolume() {
        return Math.PI * this.scale.x * this.scale.y * this.scale.z;
    }
}
